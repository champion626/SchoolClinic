...
public class FlywayApp {
    ...
    public static void migration() {
        ...
        flyway.setDataSource(config.getProperty("com.et.ar.ActiveRecordBase.url"),
                config.getProperty("com.et.ar.ActiveRecordBase.username"),
                config.getProperty("com.et.ar.ActiveRecordBase.password"));
